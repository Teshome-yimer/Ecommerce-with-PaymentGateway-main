            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    @if($relatedProduct->images && count($relatedProduct->images) > 0)
                        <img src="{{ Storage::url($relatedProduct->images[0]) }}" class="card-img-top" style="height: 200px; object-fit: cover;" alt="{{ $relatedProduct->name }}">
                    @else
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="h6 text-primary mb-0">Birr {{ number_format($relatedProduct->price, 2, '.', ',') }}</span>
                            </div>
                            <div class="d-grid gap-2">
                                <a href="{{ route('product.detail', $relatedProduct->slug) }}" class="btn btn-outline-primary btn-sm">View</a>
                                <button onclick="addToCart({{ $relatedProduct->id }})" class="btn btn-primary btn-sm">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </div>
