...
.auth-card { background: #fff; border-radius: 28px; box-shadow: 0 20px 60px rgba(99,102,241,0.13); overflow: hidden; display: flex; min-height: 580px; }
            ...
            <div class="col-xl-10 col-lg-11">
                <div class="auth-card">
                    ...
                    <div class="auth-form-side">
                        ...
                        <div class="auth-subtitle">ወደ የኛ ገበያ ለመግባት ኢሜይልዎን ያስገቡ</div>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="auth-input-wrap">
                                ...
                                <input type="email" name="email" class="auth-input @error('email') is-invalid @enderror"
                                       placeholder="ኢሜይል አድራሻ" value="{{ old('email') }}" required autofocus>
                            ...
                            <div class="auth-input-wrap">
                                ...
                                <input type="password" name="password" class="auth-input @error('password') is-invalid @enderror"
                                       placeholder="የይለፍ ቃል" required>
                                @error('password')<div style="color:#dc2626;font-size:0.8rem;margin-top:4px;">{{ $message }}</div>@enderror
                            </div>

                            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                                <label style="display:flex;align-items:center;gap:8px;font-size:0.85rem;color:#6b7280;cursor:pointer;">
                                    <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}
                                           style="accent-color:#6366f1;width:15px;height:15px;">
                                    አስታውሰኝ
                                </label>
                                @if(Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" style="font-size:0.85rem;color:#6366f1;text-decoration:none;font-weight:600;">
                                        የይለፍ ቃል ረሱ?
                                    </a>
                                @endif
                            </div>
                            ...
                            <button type="submit" class="auth-btn">
                                <i class="fas fa-sign-in-alt me-2"></i>ይግቡ
                            </button>
                        </form>
                        ...
                        <div style="text-align:center;font-size:0.88rem;color:#6b7280;">
                            መለያ የለዎትም? <a href="{{ route('register') }}" style="color:#6366f1;font-weight:700;text-decoration:none;">ይመዝገቡ</a>
                        </div>
                    </div>

                    <!-- Image Side -->
                    <div class="auth-image-side">
                        <img src="{{ asset('images/auth-side2.jpg') }}" alt="የኛ ገበያ"
