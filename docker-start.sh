...
\$lines = [
  ...
  'GOOGLE_REDIRECT_URL=' . e('GOOGLE_REDIRECT_URL', rtrim(e('APP_URL', 'https://tesheshop.app.aletcloud.com'), '/') . '/auth/google/callback'),
  '',
  'GITHUB_CLIENT_ID=' . e('GITHUB_CLIENT_ID'),
  'GITHUB_CLIENT_SECRET=' . e('GITHUB_CLIENT_SECRET'),
  'GITHUB_REDIRECT_URL=' . e('GITHUB_REDIRECT_URL', rtrim(e('APP_URL', 'https://tesheshop.app.aletcloud.com'), '/') . '/auth/github/callback'),
  '',
